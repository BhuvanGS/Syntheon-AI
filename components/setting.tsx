...
export function Settings() {
  ...
  function saveSettings() {
    localStorage.setItem('syntheon-settings', JSON.stringify({
      darkMode,
      botName,
      silenceDetection,
      notifications,
    ...
    <div className="max-w-2xl space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-lg border border-border bg-background text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
            />
            <p className="text-xs text-muted-foreground mt-1">Bot leaves after this many minutes of silence</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl p-6 border border-border">
        ...
        <div className="flex items-center justify-between py-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Automatically ship all specs without review</p>
          </div>
          <button
      ...
      <div className="bg-card rounded-2xl p-6 border border-border">
        ...
        <div className="space-y-2 text-sm text-muted-foreground">
          <p>Syntheon AI <span className="text-foreground font-medium">v1.0.0</span></p>
          <p>Built by <span className="text-foreground font-medium">Bhuvan GS</span></p>
